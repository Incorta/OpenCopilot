...
op_functions = {
    "MetaDataOp": {
        ...
        "preferred_LLM": [constants.LLMModelName.google_palm.value, LLMModelName.azure_openai_gpt_35_turbo.value, LLMModelName.azure_openai_gpt_4.value]
    },
    "QueryOp": {
        ...
        "preferred_LLM": [constants.LLMModelName.google_palm.value, LLMModelName.azure_openai_gpt_4.value, LLMModelName.azure_openai_gpt_35_turbo.value]
    },
    "UiTextOp": {
