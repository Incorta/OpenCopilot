...
op_functions = {
    constants.BusinessViewFinderOp: {
        ...
        "handle_command": business_view_finder_op.handle_command
    },
    constants.UiChartOp: {
        "get_commands_help": ui_chart_op.get_commands_help,
        "handle_command": ui_chart_op.handle_command
    },
    constants.UiTextOp: {
        "get_commands_help": ui_text_op.get_commands_help,
        "handle_command": ui_text_op.handle_command
    },
    constants.QueryOp: {
        "get_commands_help": query_op.get_commands_help,
        "handle_command": query_op.handle_command
    }
}
